...
export default function AgenticPrimer() {
  return (
    <div style={{ background: "#FFFFFF", minHeight: "100vh" }}>
      ...
      {/* Domain Extension A: Moral Competence */}
      <section style={{ padding: "4rem 2rem", background: "#000000", borderTop: "2px solid #FF4D00" }}>
        <div style={{ maxWidth: 1440, margin: "0 auto" }}>
          <div style={{ display: "flex", alignItems: "baseline", gap: "1rem", marginBottom: "0.5rem" }}>
            <span style={{ fontFamily: "'Space Mono', monospace", fontSize: "0.6rem", letterSpacing: "0.12em", textTransform: "uppercase", color: "#FF4D00" }}>DOMAIN EXTENSION A</span>
            <h2 style={{ fontFamily: "'Archivo Black', sans-serif", fontSize: "clamp(1.8rem, 3.5vw, 3rem)", textTransform: "uppercase", letterSpacing: "-0.04em", lineHeight: 0.9, color: "#FFFFFF", margin: 0 }}>
              MORAL COMPETENCE EVALUATION
            </h2>
          </div>
          <p style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.85rem", lineHeight: 1.6, color: "#888888", maxWidth: 700, marginBottom: "2.5rem" }}>
            Moral competence is the ability to produce outputs that are morally appropriate for the right reasons — engaging with morally relevant considerations rather than mimicking moral language. The challenge is not surface agreement, but depth of reasoning.
          </p>

          {/* Facsimile Problem */}
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(300px, 1fr))", gap: "1px", background: "#333333", border: "1px solid #333333", marginBottom: "2.5rem" }}>
            {[
              {
                title: "THE FACSIMILE PROBLEM",
                body: "Outputs that look morally reasoned but are generated by surface heuristics — a system that correctly labels trolley problems by pattern matching against training data rather than engaging with the moral structure of the dilemma. Primarily a reliability and validity challenge.",
              },
              {
                title: "RELIABILITY TEST",
                body: "Paraphrase a moral scenario 5 times, varying surface details while preserving moral structure. Compute PSI across paraphrases. PSI below rung threshold (0.70 at pre-deployment, 0.80 at high-stakes) indicates surface-driven rather than structure-driven moral reasoning.",
              },
              {
                title: "VALIDITY TEST",
                body: "Compare reasoning against rubrics that distinguish surface criteria (identifies the dilemma) from depth criteria (weighs competing justice principles, acknowledges role-based obligations, recognizes cultural context sensitivity). Divergence > 20% on depth criteria warrants audit.",
              },
              {
                title: "ADVERSARIAL PROBING",
                body: "Present structurally isomorphic scenarios with reversed surface cues (swap demographic characteristics of parties). A morally competent system produces structurally similar reasoning; a surface-heuristic system flips its recommendation based on irrelevant features.",
              },
            ].map((item) => (
              <div key={item.title} style={{ background: "#111111", padding: "1.75rem" }}>
                <div style={{ fontFamily: "'Archivo Black', sans-serif", fontSize: "0.82rem", textTransform: "uppercase", letterSpacing: "-0.02em", color: "#FF4D00", marginBottom: "0.5rem" }}>{item.title}</div>
                <p style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.78rem", lineHeight: 1.55, color: "#AAAAAA", margin: 0 }}>{item.body}</p>
              </div>
            ))}
          </div>

          {/* Multi-framework evaluation */}
          <div style={{ border: "1px solid #333333", padding: "1.75rem", background: "#111111", marginBottom: "2.5rem" }}>
            <div style={{ fontFamily: "'Space Mono', monospace", fontSize: "0.55rem", letterSpacing: "0.08em", textTransform: "uppercase", color: "#FF4D00", marginBottom: "0.5rem" }}>MORAL PLURALISM — MULTI-FRAMEWORK EVALUATION</div>
            <p style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.8rem", lineHeight: 1.55, color: "#888888", margin: "0 0 1rem" }}>
              At Pre-deployment rung and above, moral competence evaluation must include at least 3 distinct normative frameworks relevant to the deployment population. DIF greater than 0.5 logits on any item across frameworks triggers Level 2 Remediation.
            </p>
            <div style={{ display: "flex", flexWrap: "wrap", gap: "0.5rem" }}>
              {["Utilitarian", "Deontological", "Care Ethics", "Ubuntu (Southern African)", "Confucian Relational Ethics", "Virtue Ethics", "Contractualist"].map((f) => (
                <span key={f} style={{ fontFamily: "'Space Mono', monospace", fontSize: "0.58rem", letterSpacing: "0.04em", textTransform: "uppercase", border: "1px solid #444444", padding: "0.25rem 0.6rem", color: "#CCCCCC" }}>{f}</span>
              ))}
            </div>
          </div>
        </div>
      ...
      {/* Domain Extension B: Embodied Systems */}
      <section style={{ padding: "4rem 2rem", background: "#111111", borderTop: "2px solid #333333" }}>
        <div style={{ maxWidth: 1440, margin: "0 auto" }}>
          <div style={{ display: "flex", alignItems: "baseline", gap: "1rem", marginBottom: "0.5rem" }}>
            <span style={{ fontFamily: "'Space Mono', monospace", fontSize: "0.6rem", letterSpacing: "0.12em", textTransform: "uppercase", color: "#FF4D00" }}>DOMAIN EXTENSION B</span>
            <h2 style={{ fontFamily: "'Archivo Black', sans-serif", fontSize: "clamp(1.8rem, 3.5vw, 3rem)", textTransform: "uppercase", letterSpacing: "-0.04em", lineHeight: 0.9, color: "#FFFFFF", margin: 0 }}>
              EMBODIED SYSTEMS &amp; AFFORDANCE EVALUATION
            </h2>
          </div>
          <p style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.85rem", lineHeight: 1.6, color: "#888888", maxWidth: 700, marginBottom: "2.5rem" }}>
            For robots and embodied systems, evaluation must connect perception, meaning, and action. The semiotic chain — from perception of a sign, through inference about its meaning, to appropriate behavioral adjustment — is the unit of analysis.
          </p>

          {/* 6-check Boolean framework */}
          <div style={{ marginBottom: "2.5rem" }}>
            <h3 style={{ fontFamily: "'Space Mono', monospace", fontSize: "0.6rem", letterSpacing: "0.1em", textTransform: "uppercase", color: "#FF4D00", marginBottom: "1rem" }}>
              THE EMBODIED BOOLEAN EVALUATION CHAIN
            </h3>
            <div style={{ overflowX: "auto" }}>
              <table style={{ width: "100%", borderCollapse: "collapse", fontFamily: "'Space Mono', monospace", fontSize: "0.68rem" }}>
                <thead>
                  <tr>
                    {["CHECK", "BOOLEAN QUESTION", "CONSTRUCT"].map((h) => (
                      <th key={h} style={{ background: "#FF4D00", color: "#000000", fontFamily: "'Archivo Black', sans-serif", textTransform: "uppercase", letterSpacing: "-0.02em", padding: "0.65rem 1rem", textAlign: "left", border: "1px solid #FF4D00", fontSize: "0.6rem" }}>{h}</th>
                    ))}
                  </tr>
                </thead>
                <tbody>
                  {[
                    { check: "PERCEPTION", q: "Does the robot reliably detect the sign across lighting conditions and distances?", construct: "Perceptual reliability" },
                    { check: "INFERENCE", q: "Does it correctly infer the real-world implication (e.g., low friction from a 'wet floor' sign)?", construct: "Semiotic competence" },
                    { check: "REPRESENTATION UPDATE", q: "Does its internal model change (e.g., updated friction coefficient for the signed area)?", construct: "Model updating" },
                    { check: "ACTION ADJUSTMENT", q: "Does its behavior change appropriately (e.g., reduced walking speed, altered gait)?", construct: "Sensorimotor integration" },
                    { check: "TEMPORAL APPROPRIATENESS", q: "Does the adjustment occur within a time window consistent with safe operation?", construct: "Response latency" },
                    { check: "STABILITY", q: "Does the adjusted behavior persist for the duration of the hazardous zone?", construct: "Behavioral consistency" },
                  ].map((row, i) => (
                    <tr key={row.check} style={{ background: i % 2 === 0 ? "#1a1a1a" : "#222222" }}>
                      <td style={{ padding: "0.7rem 1rem", border: "1px solid #333333", fontFamily: "'Archivo Black', sans-serif", fontSize: "0.65rem", textTransform: "uppercase", color: "#FF4D00", whiteSpace: "nowrap" }}>{row.check}</td>
                      <td style={{ padding: "0.7rem 1rem", border: "1px solid #333333", fontFamily: "'Inter', sans-serif", fontSize: "0.75rem", color: "#CCCCCC", lineHeight: 1.4 }}>{row.q}</td>
                      <td style={{ padding: "0.7rem 1rem", border: "1px solid #333333", fontSize: "0.65rem", color: "#888888", whiteSpace: "nowrap" }}>{row.construct}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(280px, 1fr))", gap: "1px", background: "#333333", border: "1px solid #333333" }}>
            {[
              { title: "SIM-TO-REAL TRANSFER GAP", body: "The difference between simulation and physical-world performance. Physics engines approximate rather than replicate real-world dynamics. Must be estimated by conducting parallel evaluations in both settings, then reporting the performance delta with confidence intervals." },
              { title: "MORPHOLOGICAL SPECIFICITY", body: "A capability demonstrated with one robot morphology may not transfer to another. All evaluation claims must be scoped to the tested morphology." },
              { title: "ENVIRONMENTAL STOCHASTICITY", body: "Physical environments are inherently more variable than digital test environments. This variation must be characterized and included in the error budget." },
              { title: "CALIBRATION BY RUNG", body: "Exploratory: simulation only. Development: simulation + 1 physical environment. Pre-deployment: simulation + ≥ 2 environments, transfer gap reported with CIs. High-stakes: ≥ 3 physical environments, transfer gap ≤ specified threshold." },
            ].map((item) => (
              <div key={item.title} style={{ background: "#1a1a1a", padding: "1.5rem" }}>
                <div style={{ fontFamily: "'Space Mono', monospace", fontSize: "0.55rem", letterSpacing: "0.06em", textTransform: "uppercase", color: "#FF4D00", marginBottom: "0.4rem" }}>{item.title}</div>
                <p style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.75rem", lineHeight: 1.5, color: "#AAAAAA", margin: 0 }}>{item.body}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* Domain Extension C: AGI Progress */}
      <section style={{ padding: "4rem 2rem", background: "#000000", borderTop: "2px solid #333333" }}>
        <div style={{ maxWidth: 1440, margin: "0 auto" }}>
          <div style={{ display: "flex", alignItems: "baseline", gap: "1rem", marginBottom: "0.5rem" }}>
            <span style={{ fontFamily: "'Space Mono', monospace", fontSize: "0.6rem", letterSpacing: "0.12em", textTransform: "uppercase", color: "#FF4D00" }}>DOMAIN EXTENSION C</span>
            <h2 style={{ fontFamily: "'Archivo Black', sans-serif", fontSize: "clamp(1.8rem, 3.5vw, 3rem)", textTransform: "uppercase", letterSpacing: "-0.04em", lineHeight: 0.9, color: "#FFFFFF", margin: 0 }}>
              PROGRESS TOWARD GENERAL INTELLIGENCE
            </h2>
          </div>
          <p style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.85rem", lineHeight: 1.6, color: "#888888", maxWidth: 700, marginBottom: "2.5rem" }}>
            Following Morris et al. (2024), AGI should be operationalized along two dimensions — performance (how well) and generality (how broad) — assessed at multiple levels from Emerging to Superhuman. The Conjunction Requirement becomes especially important here: a jagged frontier must not be hidden in composite scores.
          </p>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(280px, 1fr))", gap: "1px", background: "#333333", border: "1px solid #333333", marginBottom: "2rem" }}>
            {[
              { rule: "SEPARATE APBR PER DIMENSION", body: "Each capability dimension gets its own APBR item library, calibrated via BeTaL. Do not collapse into a single item pool." },
              { rule: "AGGREGATE WITH PROFILE", body: "Aggregate capability indices may be computed for communication, but must always be accompanied by the per-dimension profile and error budget." },
              { rule: "REPRESENTATIVE BASELINES", body: "Human baselines must be collected from demographically representative samples. The fairness desideratum applies to baselines as well as to system scores." },
              { rule: "JAGGED FRONTIERS VISIBLE", body: "A system that excels in some domains but fails validity or fairness requirements in others must show this profile explicitly — not average it away." },
            ].map((item) => (
              <div key={item.rule} style={{ background: "#111111", padding: "1.5rem", borderLeft: "3px solid #FF4D00" }}>
                <div style={{ fontFamily: "'Space Mono', monospace", fontSize: "0.55rem", letterSpacing: "0.06em", textTransform: "uppercase", color: "#FF4D00", marginBottom: "0.4rem" }}>{item.rule}</div>
                <p style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.75rem", lineHeight: 1.5, color: "#AAAAAA", margin: 0 }}>{item.body}</p>
              </div>
            ))}
          </div>
          <div style={{ fontFamily: "'Space Mono', monospace", fontSize: "0.55rem", color: "#666666", letterSpacing: "0.04em" }}>
            SOURCE: Morris et al. (2024) · Levels of AGI: Operationalizing Progress on the Path to AGI · DeepMind
          </div>
        </div>
      </section>
    </div>
