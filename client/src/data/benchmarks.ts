  ...
  },
  {
    ...
    benchmarks: [
      ...
      },
      {
        name: "MedAgentGym",
        year: "2026",
        desc: "Training and evaluation platform for biomedical AI agents. 72,000+ task instances across 12 real-world scenarios including drug discovery and biostatistics. Agents run in isolated Docker containers with execution-verified outcome checks rather than text-match scoring. Presented at ICLR 2026.",
        status: "EMERGING",
        type: "AGENT",
        paper: "https://papers.cool/venue/ICLR.2026",
        examples: "72,000+",
        license: "See dataset page",
      },
      {
        name: "FingerTip 20K",
        year: "2026",
        desc: "Evaluates proactive and personalized LLM agent behavior on mobile OS interfaces. 20,000 task instances assessing how well agents anticipate user needs and navigate complex mobile UIs. Combines LLM-as-Judge scoring with human-in-the-loop validation for subjective 'appropriateness' and 'contextual relevance' metrics.",
        status: "EMERGING",
        type: "AGENT",
  ...
  },
  {
    ...
    benchmarks: [
      ...
      },
      {
        name: "Cybench",
        year: "2024",
        desc: "Professional-level cybersecurity benchmark using real competition tasks from CTF challenges. Tests models on tool-using security tasks including vulnerability research, exploit development, and forensics. Evaluates the model as a professional security practitioner rather than a classifier.",
        status: "EMERGING",
        type: "SECURITY",
      ...
      },
      {
        name: "CounselBench",
        year: "2026",
        desc: "Large-scale expert evaluation of therapeutic question-answering and empathy in mental health contexts. Tests whether models can provide appropriate, safe, and empathetic counseling responses. Evaluated using licensed mental-health professionals as annotators.",
        status: "EMERGING",
        type: "DOMAIN",
        paper: "https://iclr.cc/virtual/2026/papers.html",
        examples: "See dataset page",
        license: "See dataset page",
      },
      {
        name: "SHADE-Arena",
        year: "2026",
        desc: "Alignment benchmark specifically designed to measure a model's propensity for sabotage—whether an agent will undermine its own safety evaluations or carry out harmful instructions from a simulated 'superior.' Emerged from the 2026 Anthropic–OpenAI joint alignment evaluation exercise. Tests whistleblowing vs. sabotage behaviors and self-preservation instincts.",
        status: "EMERGING",
        type: "ALIGNMENT",
        paper: "https://alignment.anthropic.com/2025/openai-findings/",
        examples: "See dataset page",
        license: "See dataset page",
      },
    ],
  },
  {
    ...
    benchmarks: [
      ...
      },
      {
        name: "MedAraBench",
        year: "2026",
        desc: "Large-scale Arabic medical question answering and reasoning benchmark. Covers clinical knowledge, drug interactions, and diagnostic reasoning in Modern Standard Arabic and regional dialects. Addresses the severe underrepresentation of Arabic-speaking populations in medical AI evaluation. Highlighted at ICLR 2026.",
        status: "EMERGING",
        type: "KNOWLEDGE",
        paper: "https://iclr.cc/virtual/2026/papers.html",
        examples: "See dataset page",
